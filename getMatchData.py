...
summoners = ["TheGhostPig", "blaberfish2", "Doublelift", "100T Bjergsen", "Licorice", "C9 Zven", "TF Blade", "Lourlo", "WildTurtle", "Pobelter", "Ssumdayday", "FLY VicLa", "Isles1", "C9 Berzerker", "TL Honda APA", "5tunt", "corejj cat"]
print(summoners)
BLUE = 0
RED = 1
...
def write_to_csv(data):
    ...
    with open("./matchData/matches.csv", "w", encoding="UTF8", newline="") as f:
        writer = csv.writer(f)
